...
//
// All-integer: uint64_t limbs, unsigned __int128 in device kernels (nvcc ok),
// exact Mersenne fold.  No PCIe round-trip inside the LL loop — CUDA graph.
// Default for p < NTT_AUTO_THRESHOLD (400,000).
// ============================================================================
