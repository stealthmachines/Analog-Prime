...
**Status: TEST 1–3, 5–8 pass (TEST 4 pre-existing candidate-overflow known) — RTX 2060 (sm_75)**
...
| `hdgl_warp_ll_v33.cu` | GPU LL engine | gpucarry CUDA graph (p<400K) + NTT over M61; `NTT_AUTO_THRESHOLD=400000` |
...
| `hdgl_bench_v33.cu` | Test + benchmark | 8 test suites (TEST 1–8), field throughput at N=256K/512K/1M |
