...
| hdgl_bench_v33.cu | Test harness | 19/19 pass |
| hdgl_bench_v35b.exe | Built binary | 0.42 GSlots/s |
...
- Mind you, the 4096 alphabet characters were previously found to have collisions with other characters, while any folding operations in spare parts folder would need to correct if openGL-friendly characters are chosen, watch for this.  base4096-OpenGL-friendly.zip
